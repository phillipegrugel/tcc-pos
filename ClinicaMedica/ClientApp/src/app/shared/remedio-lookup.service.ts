...
@Injectable()
export class RemedioLookupService implements PoLookupFilter {
  ...
  getFilteredItems(filteredParams: PoLookupFilteredItemsParams): Observable<any> {
    ...
    return this.httpClient.get(this.baseUrl+'api/remedio/GetLookup');
  }

  getObjectByValue(value: string): Observable<any> {
    return this.httpClient.get(`${this.baseUrl}api/remedio${value}`);
  }
}