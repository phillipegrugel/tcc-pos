...
@Injectable()
export class ExameLookupService implements PoLookupFilter {
  ...
  getFilteredItems(filteredParams: PoLookupFilteredItemsParams): Observable<any> {
    ...
    return this.httpClient.get(this.baseUrl+'api/exame/GetLookup');
  }

  getObjectByValue(value: string): Observable<any> {
    return this.httpClient.get(`${this.baseUrl}api/exame${value}`);
  }
}