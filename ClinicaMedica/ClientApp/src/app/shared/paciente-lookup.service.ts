...
@Injectable()
export class PacienteLookupService implements PoLookupFilter {
  ...
  getFilteredItems(filteredParams: PoLookupFilteredItemsParams): Observable<any> {
    ...
    return this.httpClient.get(this.baseUrl+'api/paciente/getlookup');
  }

  getObjectByValue(value: string): Observable<any> {
    return this.httpClient.get(`${this.baseUrl}api/paciente${value}`);
  }
}